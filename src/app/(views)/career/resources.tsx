...
export default function Resources() {
  ...
  return (
    <>
      {" "}
      <Title className="text-center text-lg bg-[#7849D4] mt-16 md:text-2xl lg:text-3xl w-full !text-background">
        Creating an Inclusive Environment
      </Title>
      <section className="pb-16 px-6 sm:px-12 lg:px-20">
        <p className="px-4 sm:px-12 md:px-24 lg:px-32 text-sm md:text-base text-center">
          Lorem ipsum dolor sit amet consectetur. Nisi eget pellentesque
          condimentum vel nisl quis mattis viverra. Vel mi interdum lectus mi
          hac ultrices pulvinar. Nibh eros quam viverra viverra. Adipiscing amet
          sapien massa fringilla. Faucibus libero praesent orci volutpat
          volutpat iaculis posuere tincidunt. Gravida hac scelerisque amet sed
          aenean nunc est quisque. Ornare aliquet hendrerit eros purus vulputate
          dictum facilisis volutpat. Donec rhoncus arcu netus mi magnis
          bibendum.
        </p>
