  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        const subCategoryList = service.service_category?.subcategories || [];
        ...
        form.setFieldsValue({
          title: service.title || "",
          category: service.service_category_id?.toString(),
          subCategory: service.service_sub_categories_id?.toString(),
          img: service.image || "",
